package com.best.practice.myplus.generator;
...
/**
 * @author jiazhiyuan
 * @date 2022/2/21 7:58 下午
 */
public class MyGenerator {


    private static final String projectPath = System.getProperty("user.dir");//获取项目路径
    private static final String url = "jdbc:mysql://127.0.0.1:3306/mybatis_plus";//jdbc 路径
    private static final String username = "root";//数据库账号
    private static final String password = "123456";//数据库密码
    private static final String parentPackageName = "com.xgj";// 设置父包名
    ...
    private static final String mapperPath = projectPath + "\\src\\main\\java\\com\\xgj\\generator\\mapper\\xml\\";// 设置mapperXml 模板路径

    public static void main(String[] args) {
        String[] tableNames = {"user"};//可生成多个表
