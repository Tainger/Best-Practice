 ...
 */
public class HuisuTanxin {


    public int getMinCoinCountOfValue(int total, int[] values, int valueIndex) {
    ...
    public static void main(String[] args) {
        HuisuTanxin huisuTanxin = new HuisuTanxin();
        int minCoinCountOfValue = huisuTanxin.getMinCoinCountOfValue();
